...
while(i < Size):
    ...
    z = Norm_MinMax(Data01[i], Data01_min, Data01_max)
    Data01_Norm.append(z)

    z = Norm_MinMax(Data02[i], Data02_min, Data02_max)
...
fig.suptitle("Normalization Min-Max")

fig.tight_layout()
fig.savefig("MinMax Study.png", dpi= 240)
plt.show()
