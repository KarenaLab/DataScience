...
for Sample in Sample_List:
    ...
    print(f" > Performing Multinomial Naive Bayes for Sample = {int(Sample)}%")
    ...
    Y_Pred_Train = Multinomial_NaiveBayes.predict(X_Train)
    Y_Pred_Test = Multinomial_NaiveBayes.predict(X_Test)
...
Title = "Multinomial Naive Bayes Classifier - Iris Petals"
