...
for Sample in Sample_List:
    ...
    print(f" > Performing Bernoulli Naive Bayes for Sample = {int(Sample)}%")
    ...
    Y_Pred_Train = Bernoulli_NaiveBayes.predict(X_Train)
    Y_Pred_Test = Bernoulli_NaiveBayes.predict(X_Test)
...
Title = "Bernoulli Naive Bayes Classifier - Iris Petals"
